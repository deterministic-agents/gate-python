...
==============================
Governed Agent Trust Environment (GATE) v1.4
...
gate.output                  C20 output classification event builder + matrix
gate.invariants.break_glass  C09 break-glass record builder + verifier

License: CC BY 4.0; Andrew Stevens / deterministicagents.ai
"""

__version__ = "1.2.0"
__gate_version__ = "1.4"
